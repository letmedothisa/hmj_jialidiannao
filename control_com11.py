                        ...
                        for i in range(len(b)):
                            ...
                            if int(b[i])!=int(li_kaig[i]):
                                ...
                                if li_cunchu[i]==0:
                                    ...
                                    zaotai=li_zaotai[i]
                                    content=str(zaotai)+','+str(li_zaoy[i])
                                    data_recive=socket_client(content,zaotai)
                                    if data_recive=='ok':
...
def socket_client(content,zaotai):
    ...
    try:
        ...
        print(9000+int(zaotai),'目标主机无法连接')
