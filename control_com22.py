                ...
                if len_return_data != 0:
                    ...
                    try:
                        ...
                        if len(b)==6:
                            ...
                            sql = "update dcf_status set position_0 = '%s',position_1 = '%s',position_2 = '%s',position_3 = '%s',position_4 = '%s',position_5 = '%s',creat_time ='%s' where com='%s'" % (int(b[0]),int(b[1]),int(b[2]),int(b[3]),int(b[4]),int(b[5]),datetime.datetime.now(),com)
